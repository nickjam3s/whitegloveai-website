    ...
    <section className="py-20 bg-black">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="bg-[#7021EE]/10 p-8 rounded-lg border border-[#7021EE]/20 hover-shadow transition-all duration-300">
            ...
            <Button size="lg" className="bg-[#7021EE] hover:bg-[#7021EE]/90 transition-all duration-300 px-8 py-6 text-lg">
