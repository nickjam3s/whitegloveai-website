...
const requirements = [
  ...
  {
    icon: Zap,
    text: "Eagerness to learn and take initiative"
  },
  {
    icon: Settings,
    text: "Adaptability in a fast-paced environment"
  },
  {
    icon: Clock,
    text: "Full-time availability for internship duration"
  },
  {
    icon: Flag,
  ...
  {
    icon: GraduationCap,
    text: "Currently enrolled in or recently completed a degree in CS, Data Science, or related field"
  }
];
