  ...
  return (
    <section className="py-16 bg-purple-900 text-white">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">The Solution: GenAI Enablement Service</h2>
        <p className="text-lg mb-10 text-center max-w-4xl mx-auto">Transform your organization with our comprehensive, Whiteglove program that seamlessly integrates AI into your workflow through expert training, customized solutions, and dedicated support.</p>
        
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-purple-800/50 p-6 rounded-lg shadow-lg transform transition-all duration-300 hover:translate-y-[-5px]">
            <div className="bg-black text-white w-10 h-10 flex items-center justify-center rounded-md mb-4 font-bold">1</div>
          ...
          <div className="bg-purple-800/50 p-6 rounded-lg shadow-lg transform transition-all duration-300 hover:translate-y-[-5px]">
            <div className="bg-black text-white w-10 h-10 flex items-center justify-center rounded-md mb-4 font-bold">2</div>
          ...
          <div className="bg-purple-800/50 p-6 rounded-lg shadow-lg transform transition-all duration-300 hover:translate-y-[-5px]">
            <div className="bg-black text-white w-10 h-10 flex items-center justify-center rounded-md mb-4 font-bold">3</div>
