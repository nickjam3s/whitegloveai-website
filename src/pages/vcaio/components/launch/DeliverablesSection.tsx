    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 animate-section">
          {[
            {
              icon: <BarChart4 className="h-8 w-8 text-purple-500 mb-4" />,
            ...
            {
              icon: <FileText className="h-8 w-8 text-purple-500 mb-4" />,
            ...
            {
              icon: <HeartHandshake className="h-8 w-8 text-purple-500 mb-4" />,
