...
const ExecutiveProfile: React.FC<ExecutiveProfileProps> = ({ 
  ...
  return (
    <motion.div
      className="glass-card overflow-hidden cursor-pointer group relative rounded-lg border border-[#333333] hover:border-[#7021EE]/40 transition-all duration-300 hover:shadow-[0_0_0_1px_#7021EE]"
    ...
    >
      ...
      <div className="p-6 bg-gradient-to-br from-[#320B70]/90 to-[#111111]">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-white hover:text-[#9b87f5] transition-colors mt-2 linkedin-link"
