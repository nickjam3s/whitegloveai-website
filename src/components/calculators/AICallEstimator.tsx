...
const AICallEstimator = () => {
  ...
  return <div className="w-full max-w-4xl mx-auto bg-card rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="totalCalls" type="number" min="0" step="1" value={totalDailyCalls} onChange={handleTotalCallsChange} className="w-full bg-background text-white" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                <Slider id="percentageAI" min={0} max={100} step={1} value={[percentageAICanHandle]} onValueChange={handlePercentageChange} className="flex-1" />
            ...
            <div className="space-y-2">
              ...
              <Input id="interactionTime" type="number" min="0" step="0.1" value={avgInteractionTime} onChange={handleInteractionTimeChange} className="w-full bg-background text-white" />
            </div>
          </div>
          ...
          <div className="bg-card/60 rounded-lg p-6 border border-primary/20">
            ...
            <div className="space-y-8">
              ...
              {/* Calculation Summary */}
              <div>
                <button onClick={() => setShowSummary(!showSummary)} className="text-sm text-gray-400 hover:text-primary transition-colors flex items-center gap-1">
                  {showSummary ? 'Hide' : 'Show'} calculation details
                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 transition-transform ${showSummary ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
                
                {showSummary && <div className="mt-3 text-sm text-gray-300 space-y-1">
