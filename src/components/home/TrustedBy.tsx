...
const logos = [
  ...
  { src: '/lovable-uploads/f0ca996d-42e2-4524-b115-7ff8ed634282.png', alt: 'Principal Logo', height: 80 },
  { src: '/lovable-uploads/cbc64b44-084f-482b-8637-adfe22d6c0ec.png', alt: 'University Logo', height: 80 },
  { src: '/lovable-uploads/31ce2c79-4446-474c-944b-387098eef691.png', alt: 'Kofile Logo', height: 80 },
  { src: '/lovable-uploads/b6a654ad-cab3-433b-b6d1-d7783e010859.png', alt: 'MEDC Logo', height: 80 },
  ...
  { src: '/lovable-uploads/59a4884a-03e1-43ef-a6d1-e79c5ca8e3ea.png', alt: 'New Logo', height: 80 },
];

// Static grid logos with the new logo added at the beginning
const staticGridLogos = [
  { src: '/lovable-uploads/c0e45a43-6f9f-4579-af85-ed5c9bfa2e58.png', alt: 'New Client Logo', height: 80 },
  ...logos
];
